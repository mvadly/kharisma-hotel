...
<div class="page-header">
    <h2>Gallery <small>Foods and Drinks</small></h2>
</div>
<div class="row">
...
<div class="form-group">
	<?php
	$folderc2 = "assets/umum/images/fnd";
	...
	$i = 1; 
                ...
                if(in_array(end($fileAndExt2), $fileGambar)){?>
                	<div class="col-md-3">
                            <div class="thumbnail">
                                <a href="<?php echo base_url('assets/umum/images/fnd/'.$file2); ?>" data-gallery>
                                <img src="<?php echo base_url('assets/umum/images/fnd/'.$file2); ?>"  class="img-responsive " style="min-height: 150px;max-height: 150px;"></a>
                                <div class="caption">
                                  <a href="<?php echo base_url('admin/gallery/hapus_fnd/'.$file2) ?>" class="btn bg-red form-control">Hapus</a>
                                </div>
...
url: "<?php echo base_url('admin/gallery/upload_fnd') ?>",
maxFilesize: 2,
method:"post",
acceptedFiles:"image/*",
paramName:"userfile",
